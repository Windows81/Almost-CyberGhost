...
- **[`_.txt`](./_.txt):** a list of CyberGhost HTTPS proxy hosts (connect vía port 9002, no authentication required).
- **[`_.sh`](./_.sh):** a simple one-liner which utilises [the Shodan CLI tool](https://cli.shodan.io/).  You'll need an API key (I have one as of 2026-02).
